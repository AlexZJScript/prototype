            ...
            {({values}) => (
                <FormikForm className={styles.form}>
                    <InputAutocomplete
                        ...
                        bottomSheetHeaderAddonsProps={recipientNameOrInnFilterProps}
                    ...
                    <InputAutocomplete
                        ...
                        bottomSheetHeaderAddonsProps={recipientBankNameOrBikFilterProps}
                    ...
                    <div className={cn(styles.commissionContainer, styles.commissionField)}>
                        <div>
                            <Typography.Text className={styles.commissionText} view='primary-medium'>
                                {values.amount ? (
                    ...
                    <div className={styles.formAction}>
                        ...
                        <PickerButton optionsListClassName={styles.optionsList} bottomSheetProps={pickerButtonBottomSheetProps} options={PickerButtonOptions} variant='compact' size='m'/>
                    </div>
                </FormikForm>
            )}
        </Formik>
